...
ap.add_argument("--xlim", required=True, type=float, nargs='+')
...
for j, (h_baseline, h_ours) in enumerate(zip(baselines, ours)):
    ...
    if loss_types[j] == 'ce':
        ...
        ax3.plot(b_up, b_acc, 'b')
        ax3.plot(o_up, o_acc, 'r')
    else:
