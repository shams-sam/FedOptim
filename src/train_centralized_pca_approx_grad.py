...
model_name = 'clf_{}_noise_{}_paradigm_{}_nc_{}' \
    '_lr_{}_decay_{}_batch_{}'.format(
        args.clf, args.noise, args.paradigm, args.num_comp,
...
grad_file = '../ckpts/{}_centralized/data/grad_pca_paradigm_{}_batch'\
            '_{}_components_{}.pkl'.format(
                args.dataset, args.paradigm, args.batch_size, args.num_comp)
grad_pca_w, grad_pca_b = pkl.load(open(grad_file, 'rb'))
...
for epoch in range(1, args.epochs + 1):
    ...
    for data, target in train_loader:
        ...
        gradient_approximation(
            model, [grad_pca_w, grad_pca_b], device)
