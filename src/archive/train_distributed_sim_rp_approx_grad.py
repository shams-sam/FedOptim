...
model_name = 'clf_{}_noise_{}_paradigm_{}_rp_{}' \
...
grad_rp_w = torch.normal(0.0, 1.0,
                         size=(args.num_comp, 7840)).to(device)
grad_rp_b = torch.normal(0.0, 1.0,
                         size=(args.num_comp, 10)).to(device)
...
for epoch in range(1, args.epochs + 1):
    ...
    for data, target in train_loader:
        ...
        gradient_approximation(
            model, [grad_rp_w, grad_rp_b], device)
