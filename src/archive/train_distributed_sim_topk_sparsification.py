...
from utils import accumulate_topk_grads_over_epochs, \
    accumulate_grads_over_epochs, \
...
model_name = 'clf_{}_noise_{}_paradigm_{}_topk_{}' \
    '_lr_{}_decay_{}_batch_{}_distributed_sim'.format(
        args.clf, args.noise, args.paradigm, args.topk,
