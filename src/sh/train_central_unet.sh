...
################################################################################
voc(){
    python train_centralized.py --device-id 2 1 0 --dataset voc --clf unet --paradigm sgd --batch-size 32 --epochs 301 --lr 1e-4 --momentum 0.9 --repeat 0.5 --dry-run 0 --early-stopping 0 &
}
