...
################################################################################
cifar100(){
    python train_distributed.py --device-id 1 2 0 --dataset cifar100 --clf cnn --paradigm signsgd --optim sgd --num-workers 100 --batch-size 0 --test-batch-size 128 --epochs 201 --lr 1e-1 --momentum 0.9 --scheduler 1 --non-iid $n --repeat 1 --dry-run 0 &
}
