...
################################################################################
cifar(){
    python train_federated.py --device-id 1 2 0 --dataset cifar --clf cnn --optim sgd --num-workers 100 --batch-size 0 --test-batch-size 128 --epochs 1001 --lr 1e-2 --momentum 0.9 --scheduler 1 --non-iid $n --repeat 1 --dry-run 0 --save-model 1 &
}
