debug(){
    python gen_dga_dirs.py --device-id 0 --dataset mnist --clf resnet18 --optim sgd --num-workers 10 --epochs 51 --lr 0.01 --non-iid 10 --repeat 1 --dga-bs 16 --num-dga 1 --dry-run 1
...
mnist(){
    python gen_dga_dirs.py --device-id 1 --dataset mnist --clf resnet18 --optim sgd --num-workers 100 --epochs 51 --lr 0.01 --non-iid 1 --repeat 1 --dga-bs 16 --num-dga 1 --dry-run 0
    python gen_dga_dirs.py --device-id 1 --dataset mnist --clf resnet18 --optim sgd --num-workers 100 --epochs 51 --lr 0.01 --non-iid 10 --repeat 1 --dga-bs 16 --num-dga 1 --dry-run 0

    python gen_dga_dirs.py --device-id 1 --dataset mnist --clf fcn --optim sgd --num-workers 100 --epochs 51 --lr 0.01 --non-iid 1 --repeat 1 --dga-bs 16 --num-dga 1 --dry-run 0
    python gen_dga_dirs.py --device-id 1 --dataset mnist --clf fcn --optim sgd --num-workers 100 --epochs 51 --lr 0.01 --non-iid 10 --repeat 1 --dga-bs 16 --num-dga 1 --dry-run 0
}
