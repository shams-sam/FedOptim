...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_celeba_fcn_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_celeba_resnet18_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_celeba_vgg19_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar_fcn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar_resnet18_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar_vgg19_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar100_cnn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar100_fcn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar100_resnet18_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_cifar100_vgg19_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_coco_unet_512
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_fmnist_cnn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_fmnist_fcn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_fmnist_resnet18_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_fmnist_vgg19_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_mnist_cnn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_mnist_fcn_128
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_mnist_resnet18_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_mnist_vgg19_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_imagenet_256
}
...
python viz/prelim_3.py --h \
    ...
    --dry-run $dry --final $final \
    --save ../ckpts/plots/prelim_3_voc_unet_32
}
