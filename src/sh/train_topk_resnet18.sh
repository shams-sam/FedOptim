...
################################################################################
celeba(){
    python train_federated.py --device-id 0 1 2 --dataset celeba --clf resnet18 --paradigm topk --topk $k --optim sgd --num-workers 10 --batch-size 0 --test-batch-size 128 --epochs 101 --test-type fl --lr 1e-5 --momentum 0.9 --loss-type mse --non-iid 0 --residual 1 --repeat 0.4 --dry-run 0 &
}
...
################################################################################
cifar(){
    python train_federated.py --device-id 1 0 2 --dataset cifar --clf resnet18 --paradigm topk --topk $k --optim sgd --num-workers 10 --batch-size 0 --test-batch-size 128 --test-type fl --epochs 201 --lr 1e-2 --momentum 0.9 --scheduler 0 --non-iid $n --residual 1 --repeat 1 --dry-run 0 &
}
