...
################################################################################
cifar(){
    python train_federated.py --device-id 2 1 0 --dataset cifar --clf resnet18 --optim sgd --num-workers 10 --batch-size 0 --test-batch-size 128 --epochs 201 --lr 1e-1 --momentum 0.9 --scheduler 1 --non-iid $n --repeat 1 --dry-run 0 --save-model 0
}
...
################################################################################
cifar100(){
    python train_federated.py --device-id 2 1 0 --dataset cifar100 --clf resnet18 --optim sgd --num-workers 10 --batch-size 0 --test-batch-size 128 --epochs 201 --lr 1e-1 --momentum 0.9 --scheduler 0 --non-iid $n --repeat 1 --dry-run 0 --save-model 0
}
