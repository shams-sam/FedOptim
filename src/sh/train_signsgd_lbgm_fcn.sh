...
celeba(){
    ...
    python train_federated.py --device-id 1 2 --dataset celeba --clf fcn --paradigm signsgd lbgm --error-tol 0.8 --optim sgd --num-workers 100 --batch-size 0 --test-batch-size 128 --epochs 101 --lr 1e-4 --momentum 0.9 --loss-type mse --non-iid 0 --repeat 0.4 --dry-run 0 &
}
...
################################################################################
fmnist(){
    python train_federated.py --device-id 1 2 0 --dataset fmnist --clf fcn --paradigm signsgd lbgm --error-tol 0.8 --optim sgd --num-workers 100 --batch-size 0 --test-batch-size 128 --epochs 101 --lr 1e-4 --momentum 0.9 --non-iid 10 --repeat 1 --dry-run 0 &
}
...
################################################################################
mnist(){
    python train_federated.py --device-id 1 2 0 --dataset mnist --clf fcn --paradigm signsgd lbgm --error-tol 0.8 --optim sgd --num-workers 100 --batch-size 0 --test-batch-size 128 --epochs 101 --lr 1e-4 --momentum 0.9 --non-iid 10 --repeat 1 --dry-run 0 &
}
