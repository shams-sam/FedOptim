...
read: https://stackoverflow.com/questions/63015883/pytorch-based-resnet18-achieves-low-accuracy-on-cifar100
...
__all__ = ['ResNet', 'resnet18', 'resnet20', 'resnet32', 'resnet34',
           'resnet44', 'resnet56', 'resnet101', 'resnet110', 'resnet152', 'resnet1202']
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_channels=3, num_classes=100):
...
def resnet101(num_channels=3, num_classes=10):
    return ResNet(BasicBlock2, [3, 4, 23, 3],
                  num_channels=num_channels, num_classes=num_classes)
...
def resnet152(num_channels=3, num_classes=10):
    return ResNet(BasicBlock2, [3, 8, 36, 3],
                  num_channels=num_channels, num_classes=num_classes)
